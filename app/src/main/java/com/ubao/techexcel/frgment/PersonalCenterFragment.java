...
import com.ubao.techexcel.pc.ui.ChangePasswordActivity;
import com.ubao.techexcel.pc.ui.EffectiveActivity;
import com.ubao.techexcel.pc.ui.PersonalInfoActivity;
import com.ubao.techexcel.pc.ui.ProfessionalFieldActivity;
import com.ubao.techexcel.pc.ui.SelfDescriptionActivity;
import com.ubao.techexcel.personal.LanguageActivity;
import com.ubao.techexcel.personal.MyAccountActivity;
import com.ubao.techexcel.personal.MyCourseTemplateActivity;
import com.ubao.techexcel.personal.PersanalCollectionActivity;
import com.ubao.techexcel.personal.SchoolProfileActivity;
import com.ubao.techexcel.personal.TeacherProfileActivity;
import com.ubao.techexcel.school.SelectSchoolActivity;
import com.ubao.techexcel.start.LoginActivity;
import com.ubao.techexcel.start.LoginGet;
import com.ubao.techexcel.tool.SoftInputUtils;
import com.ubao.techexcel.ui.MainActivity;
...
//                SoftInputUtils.hideSoftInput(getActivity());
    ...
    private void UpdateClassRoomID(final String classRoomId) {
        ...
        if (TextUtils.isEmpty(classRoomId) || (classRoomId.length() < 3)) {
            ...
            Toast.makeText(getActivity(),
                    "Room ID must contain numbers and letters ",
                    Toast.LENGTH_SHORT).show();
            return;
        } else {
